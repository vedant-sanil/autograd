...
X getdimsize(X first, Args... args) {
    return first * getdimsize(args...);
}
...
/**
 * Variadic packing for Array struct 
 */
template<typename T, unsigned dim1, unsigned ... rest_dim >
struct Array <T, rest_dim...> {
    ...
    public:
        unsigned int* shape;
        static T aoob; 
        typedef typename T OneDimensionDownArrayT;
        
        typedef OneDimensionDownArrayT type[dim1];
        //static const T aoob;
        // Accessor methods
